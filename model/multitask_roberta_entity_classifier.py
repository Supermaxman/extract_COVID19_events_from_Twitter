...
def main():
	...
	if args.retrain:
		...
		tokenizer = RobertaTokenizer.from_pretrained(args.pre_model)
		config = RobertaConfig.from_pretrained(args.pre_model)
		...
		tokenizer = RobertaTokenizer.from_pretrained(args.save_directory)
